...
* Для загрузки проекта на удаленный сервер, можно выбрать метод загрузки ([rsync][gulp-rsync] или [sftp][gulp-sftp]), путем проставления нужного значения переменной `deployMethod`.
